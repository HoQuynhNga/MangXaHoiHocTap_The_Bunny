<?php
// 1. NẠP CẤU HÌNH VÀ KIỂM TRA QUYỀN TRUY CẬP (AUTHORIZATION)
...
try {
    ...
    $recent_users = $pdo->query("SELECT id, ho_ten, email, role, created_at FROM users ORDER BY id DESC LIMIT 5")->fetchAll();
    
    // Lấy 5 bài viết mới nhất để kiểm duyệt
    $recent_posts = $pdo->query("
        SELECT b.id, b.noi_dung, b.created_at, u.ho_ten 
        FROM bai_dang b 
        ...
        <div class="col-md-10 p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <span class="fw-bold"><?php echo $_SESSION['ho_ten']; ?></span>
                </div>
            </div>
                                ...
                                <table class="table table-hover align-middle m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="fw-bold"><?= htmlspecialchars($u['ho_ten']) ?></div>
                                                <small class="text-muted"><?= htmlspecialchars($u['email']) ?></small>
                                            </td>
                                            <td>
                                                <?php 
                                                    if($u['role'] == 'admin') echo '<span class="badge bg-danger">Admin</span>';
                                                    elseif($u['role'] == 'teacher') echo '<span class="badge bg-info">Giáo viên</span>';
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item px-0 py-3">
                                    <div class="d-flex justify-content-between mb-1">
                                        <strong class="text-primary"><?= htmlspecialchars($post['ho_ten']) ?></strong>
